(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".top-header__menu-icon")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".top-header__menu-icon")) {
                    bodyLockToggle();
                ...
                if (optionMenu) {
                    ...
                    options.forEach((option => {
                        option.addEventListener("click", (function(e) {
                            if (null != e.target.classList.contains(".select__option-text")) if (sBtntext) sBtntext.value = e.target.innerText;
                            if (selBtntext_2) if (null != document.querySelector(".select__option-text")) selBtntext_2.innerText = option.querySelector(".select__option-name").innerText + option.querySelector(".select__option-number").innerText;
                            if (selBtntext_1) if (null != document.querySelector(".select__option-text")) selBtntext_1.innerText = option.querySelector(".select__option-text-data").innerText + option.querySelector(".select__option-text-name").innerText + option.querySelector(".select__option-text-number").innerText + option.querySelector(".select__option-text-name-2").innerText;
                            options.forEach((el => {
        ...
        function formFieldsInit(options = {
            ...
            var inputTel = document.querySelectorAll(".input-tel");
            if (inputTel) inputTel.forEach((tel => {
                tel.addEventListener("click", (function(e) {
                    tel.value = "+";
                }));
            }));
            var inputGame = document.querySelectorAll(".input-game");
            if (inputGame) inputGame.forEach((game => {
        ...
        let formValidate = {
            ...
            addError(formRequiredItem) {
                ...
                body.classList.add("_form-error");
            ...
            removeError(formRequiredItem) {
                ...
                body.classList.remove("_form-error");
        ...
        var forms_textarea = document.getElementsByTagName("textarea")[0];
        forms_textarea.addEventListener("keydown", resize);
        function resize() {
            var el = this;
            setTimeout((function() {
                el.style.cssText = "min-height:30px; padding: 4px 45px 4px 10px;";
 ...
 */
        ...
        const data = document.querySelectorAll(".data-search");
        if (data) Inputmask({
            mask: "99/99/9999"
        }).mask(data);
        ...
        if (document.querySelector(".swiper-games__slider")) new core(".swiper-games__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            preloadImages: false,
            navigation: {
                prevEl: ".swiper-games__arrow-prev",
                nextEl: ".swiper-games__arrow-next"
            }
        });
        ...
        da.init();
        const buttonCode = document.querySelector(".active-timer-button");
        const buttonCodeSubmit = document.querySelector(".code");
        function timer() {
            function startTimer(duration, display) {
                let minutes, seconds, t = duration;
                let handle = setInterval((function() {
                    ...
                    buttonCodeSubmit.classList.add("_active");
                    buttonCode.classList.add("_active-timer");
                    if (--t < 0) {
                        t = duration;
                        clearInterval(handle);
                        buttonCode.classList.remove("_active-timer");
                    }
                }), 1e3);
            }
            let fiveMinutes = 60 * 1.5;
            let display = document.querySelector(".time");
            startTimer(fiveMinutes, display);
        }
        if (buttonCode) {
            buttonCodeSubmit.addEventListener("click", timer);
            buttonCode.addEventListener("click", timer);
        }
        const passwordButton = document.querySelector(".login__button-password");
        function script_password() {
            if (passwordButton) {
                const passwordStep_2 = document.querySelector(".forgot-password-step-2");
                const passwordSuccessfully = document.querySelector(".forgot-password__successfully");
                passwordButton.addEventListener("click", (function(e) {
                    passwordStep_2.classList.add("_active");
                    passwordSuccessfully.classList.add("_active");
                }));
            }
        }
        script_password();
        function registration() {
            const registrationStep_2 = document.querySelector(".registration__inputs-step-2");
            if (registrationStep_2) buttonCodeSubmit.addEventListener("click", (function(e) {
                buttonCodeSubmit.classList.add("_active");
                registrationStep_2.classList.add("_active");
            }));
        }
        registration();
        ...
        const copyText_2 = document.querySelector("#inputCopy2");
        if (copyText_2) {
            function copy() {
                copyText_2.select();
                document.execCommand("copy");
        ...
        const megaphoneLink = document.querySelector(".megaphone-top-header__link");
        function megaphone() {
            if (megaphoneLink) {
                megaphoneLink.addEventListener("click", (function(e) {
                    document.documentElement.classList.toggle("_megaphone-active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".megaphone-top-header__body") && !target.closest(".megaphone-top-header__link")) document.documentElement.classList.remove("_megaphone-active");
                }));
                if (document.documentElement.classList.contains("search-open")) document.documentElement.classList.remove("_megaphone-active");
            }
        }
        megaphone();
        const searchMob = document.querySelector(".top-header__search-mob");
        function search() {
            if (searchMob) {
                searchMob.addEventListener("click", (function(e) {
                    document.documentElement.classList.toggle("search-open");
                }));
                if (document.documentElement.classList.contains("_megaphone-active")) document.documentElement.classList.remove("search-open");
            }
        }
        search();
        const checkboxLabels = document.querySelectorAll(".checkbox__label");
        function tippy() {
            if (checkboxLabels) checkboxLabels.forEach((checkboxLabel => {
                checkboxLabel.addEventListener("click", (function(e) {
                    checkboxLabel.nextElementSibling.classList.toggle("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".checkbox__label") && !target.closest(".checkbox__tippy")) checkboxLabel.nextElementSibling.classList.remove("_active");
                }));
            }));
        }
        tippy();
        ...
        function tippyItem() {
            if (teamItems) teamItems.forEach((item => {
                item.addEventListener("click", (function(e) {
                    item.nextElementSibling.classList.toggle("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".team__items") && !target.closest(".team__tippy")) item.nextElementSibling.classList.remove("_active");
                }));
            }));
        }
        tippyItem();
        const causeFailureReply = document.querySelector(".cause-failure-reply");
        function popupCauseFailure() {
            if (causeFailureReply) {
                const causeFailureSlide_1 = document.querySelector(".cause-failure-slide-1");
                const causeFailureSlide_2 = document.querySelector(".cause-failure-slide-2");
                const causeFailureSlide_3 = document.querySelector(".cause-failure-slide-3");
                const causeFailureSlideBtn = document.querySelector(".cause-failure-button");
                const reasonClose = document.querySelector(".reason-close");
                causeFailureReply.addEventListener("click", (function(e) {
                    causeFailureSlide_1.classList.add("_active");
                    causeFailureSlide_2.classList.add("_active");
                }));
                causeFailureSlideBtn.addEventListener("click", (function(e) {
                    causeFailureSlide_3.classList.add("_active");
                    causeFailureSlide_2.classList.remove("_active");
                    reasonClose.classList.add("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".cause-failure-button") && !target.closest(".cause-failure-slide-1") && !target.closest(".cause-failure-slide-2") && !target.closest(".cause-failure-slide-3")) {
                        reasonClose.classList.remove("_active");
                        causeFailureSlide_1.classList.remove("_active");
                        causeFailureSlide_3.classList.remove("_active");
                    }
                }));
            }
        }
        popupCauseFailure();
        const luckReply = document.querySelector(".luck-reply");
        function popupLuck() {
            if (luckReply) {
                const luckSlide_1 = document.querySelector(".luck-slide-1");
                const luckSlide_2 = document.querySelector(".luck-slide-2");
                const luckSlide_3 = document.querySelector(".luck-slide-3");
                const luckSlideBtn = document.querySelector(".luck-button");
                const luckClose = document.querySelector(".luck-close");
                luckReply.addEventListener("click", (function(e) {
                    luckSlide_1.classList.add("_active");
                    luckSlide_2.classList.add("_active");
                }));
                luckSlideBtn.addEventListener("click", (function(e) {
                    luckSlide_3.classList.add("_active");
                    luckSlide_2.classList.remove("_active");
                    luckClose.classList.add("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".luck-button") && !target.closest(".luck-slide-1") && !target.closest(".luck-slide-2") && !target.closest(".luck-slide-3")) {
                        luckClose.classList.remove("_active");
                        luckSlide_1.classList.remove("_active");
                        luckSlide_3.classList.remove("_active");
                    }
                }));
            }
        }
        ...
        function infoProfile() {
            const infoProfileTitle = document.querySelector(".info-account-popup-title");
            const infoProfileSubTitle = document.querySelector(".info-account-popup-subtitle");
            if (infoProfileTitle) {
                const infoProfileInputTitle = document.querySelector(".account-popup__input-title");
                infoProfileTitle.addEventListener("click", (function(e) {
                    infoProfileInputTitle.classList.add("_active");
                    infoProfileTitle.classList.add("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".account-popup__input-title") && !target.closest(".info-account-popup-title") && !target.closest(".account-popup__input-subtitle") && !target.closest(".info-account-popup-subtitle")) {
                        infoProfileInputTitle.classList.remove("_active");
                        infoProfileTitle.classList.remove("_active");
                    }
                }));
            }
            if (infoProfileSubTitle) {
                const infoProfileInputSubTitle = document.querySelector(".account-popup__input-subtitle");
                infoProfileSubTitle.addEventListener("click", (function(e) {
                    infoProfileInputSubTitle.classList.add("_active");
                    infoProfileSubTitle.classList.add("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".account-popup__input-subtitle") && !target.closest(".info-account-popup-subtitle") && !target.closest(".account-popup__input-title") && !target.closest(".info-account-popup-title")) {
                        infoProfileInputSubTitle.classList.remove("_active");
                        infoProfileSubTitle.classList.remove("_active");
                    }
                }));
            }
        }
        infoProfile();
        const cartBlockInputFile = document.querySelectorAll(".popup__upload-photo");
        if (cartBlockInputFile) cartBlockInputFile.forEach((el => {
            el.addEventListener("change", (event => {
                ...
                for (var f, i = 0; f = file[i]; i++) {
                    ...
                    const inputImg = document.querySelectorAll(".upload-photo-popup__content");
                    var span = document.createElement("span");
                    reader.onload = function(theFile) {
                        return function cartBlockFileMask(e) {
                            span.className = "upload-photo-popup__preview";
        ...
        function unsubscribe() {
            const subscribersButton = document.querySelectorAll(".subscribers-popup__button");
            const unsubscribersButton = document.querySelectorAll(".subscribers-popup__button-unsubscribe");
            if (subscribersButton) subscribersButton.forEach((btn => {
                btn.addEventListener("click", (async e => {
                    let parent = e.target.parentNode;
                    if (parent.classList.contains("_active")) {
                        parent.classList.remove("_active");
                        unsubscribersButton.forEach((item => {
                            item.classList.remove("_active");
                        }));
                    } else parent.classList.add("_active");
                }));
            }));
        }
        unsubscribe();
        function ribbon() {
            const button = document.querySelectorAll(".center-item-ribbon__main-block");
            if (button) button.forEach((btn => {
                btn.addEventListener("click", (async e => {
                    let parent = e.target.parentNode;
        ...
        ribbon();
        function message() {
            const chatMessages = document.querySelectorAll(".left-message__column");
            if (chatMessages) {
                const chatMessagesButton = document.querySelector(".right-message__name");
                chatMessages.forEach((chatMessage => {
                    chatMessage.addEventListener("click", (function(e) {
                        document.documentElement.classList.add("active");
                    }));
                    chatMessagesButton.addEventListener("click", (function(e) {
